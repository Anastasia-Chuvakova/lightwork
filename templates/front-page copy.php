...
<head>
    ...
    <!-- FontAwesome, Bootstrap, Theme CSS-->
...
<body>
    ...
    <header class="header text-center">	    
	    <a class="site-title pt-lg-4 mb-0" href="index.html">lightwork</a>
    ...
    <div class="main-wrapper">
	    ...
	    <footer class="footer text-center py-2 theme-bg-dark">
            ...
            <p class="copyright"><a href="https://youtube.com/FollowAndrew">lightwork</a></p>
